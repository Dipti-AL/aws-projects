...
![Instance B Networking Tab](lab_261_262/1.png)

![Instance A Networking Tab](lab_261_262/2.png)
...
![Ping Google from Instance B](lab_261_262/3.png)

![Ping Instance A Private IP](lab_261_262/4.png)
...
![Public IP Released on Stop](lab_261_262/5.png)

* **Action**: Restarted the instance. AWS assigned a new, random dynamic public IP (54.186.68.83).

![New Dynamic IP Assigned on Start](lab_261_262/6.png)
...
![Allocating Elastic IP](lab_261_262/7.png)
...
![Instance Stopped with EIP](lab_261_262/8.png)

![Final Static IP Verification](lab_261_262/9.png)
